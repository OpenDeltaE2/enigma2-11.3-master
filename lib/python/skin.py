...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "delta-blackblue-fhd/skin.xml" or "AREADELTASAT-FHD/skin.xml"  # SD hardware is no longer supported by the default skin.
