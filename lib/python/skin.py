...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "skins-delta-blackblue-fhd/skin.xml" or "skins-delta-black-fhd/skin.xml"  # SD hardware is no longer supported by the default skin.
