...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "AREADELTASAT-FHD/skin.xml" or "delta-blackblue-fhd/skin.xml"  # SD hardware is no longer supported by the default skin.
